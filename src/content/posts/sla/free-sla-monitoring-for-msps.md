...
- **Exit1.dev monitors** across HTTP, API, and synthetic journeys. The free tier covers 50 monitors with 5-minute checks. The Nano tier ($9/month) unlocks 250 monitors with 30-second checks — scale across clients without a pricing migraine.
