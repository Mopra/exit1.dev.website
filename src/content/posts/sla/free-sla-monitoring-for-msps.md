...
- **Exit1.dev monitors** across HTTP, API, and synthetic journeys. The free tier covers 5 monitors with 5-minute checks. The Nano tier ($9/month) unlocks 100 monitors with 2-minute checks — scale across clients without a pricing migraine.
