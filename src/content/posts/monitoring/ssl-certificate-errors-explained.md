...
- **Monitor all certificates** with [exit1.dev](https://app.exit1.dev) — 10 free monitors with 5-minute checks and multi-channel alerts (upgrade to Nano for unlimited monitors and 1-minute checks at $5/month)
