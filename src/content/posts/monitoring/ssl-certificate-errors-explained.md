...
- **Monitor all certificates** with [exit1.dev](https://app.exit1.dev) — 50 free monitors with 5-minute checks and multi-channel alerts (upgrade to Nano for 250 monitors and 30-second checks at $9/month)
