...
**Free tier:** up to 50 monitors with 5-minute checks, alerts, and status pages, no card required.
**Nano ($9/month):** 250 monitors with 30-second checks.
...
Yes. The free tier covers up to 50 SSL monitors with 5-minute checks, alerts, and status pages, no card required. Need more? Nano ($9/month) unlocks 250 monitors with 30-second checks.
