...
- **Short polling for critical paths**: Mission-critical APIs deserve the fastest interval your plan allows (15-second on Pro). Brochure sites can chill at 5 minutes.
...
Exit1.dev’s free plan handles up to 50 monitors with 5-minute checks, global probes, Slack webhooks, and status pages. The Nano plan ($9/month) unlocks 250 monitors with 30-second checks. Pay more only if you need:
