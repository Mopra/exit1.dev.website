...
Exit1.dev’s free plan gives you up to 10 monitors with 5-minute checks, email alerts, and status pages. The Nano plan ($5/month) unlocks unlimited monitors with 1-minute checks. Only add SMS, chat, or phone trees if:
