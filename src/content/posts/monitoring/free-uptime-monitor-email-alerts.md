...
Exit1.dev’s free plan gives you up to 5 monitors with 5-minute checks, email alerts, and status pages. The Nano plan ($9/month) unlocks 100 monitors with 2-minute checks. Only add SMS, chat, or phone trees if:
