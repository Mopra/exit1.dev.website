...
Exit1.dev’s free plan gives you up to 50 monitors with 5-minute checks, email alerts, and status pages. The Nano plan ($9/month) unlocks 250 monitors with 30-second checks. Only add SMS, chat, or phone trees if:
