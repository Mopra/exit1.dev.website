...
Exit1.dev's free tier gives you up to 10 SSL monitors with 5-minute checks, email alerts, and status pages. The Nano plan ($5/month) unlocks unlimited monitors with 1-minute checks. Upgrade beyond that only if you need:
