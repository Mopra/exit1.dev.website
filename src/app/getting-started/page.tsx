        ...
        <PageContainer>
          <PageSection className="pt-24 sm:pt-28 pb-16">
            <SectionContent size="lg" className="text-center py-12 sm:py-16 lg:py-20">
              <Badge
                variant="secondary"
                className="mb-4 sm:mb-6 text-sm font-medium bg-foreground/10 text-foreground border border-foreground/10"
              >
              ...
              <p className="text-xl text-foreground/70 mb-8 max-w-3xl mx-auto px-4 leading-relaxed">
          ...
          <PageSection id="quick-start" className="py-8 scroll-mt-20">
            <SectionContent size="lg">
              <div className="max-w-4xl mx-auto">
                ...
                <ol className="mt-6 space-y-4 text-foreground/70 text-lg list-decimal pl-6">
                  <li>
                    <span className="text-foreground font-semibold">Create your first check:</span> Add a URL or host:port to
                    monitor.
                  </li>
                  <li>
                    <span className="text-foreground font-semibold">Pick the right interval:</span> Use longer intervals unless
                    the service is truly critical.
                  </li>
                  <li>
                    <span className="text-foreground font-semibold">Enable alerts:</span> Turn on Email, SMS, or Webhooks (or
                    all three).
                  </li>
                  <li>
                    <span className="text-foreground font-semibold">Verify delivery:</span> Send a test Email/SMS or test a
                    webhook.
                  </li>
                  <li>
                    <span className="text-foreground font-semibold">Watch Logs:</span> Confirm your first events and understand
                    how logs are stored.
                  </li>
                </ol>
              </div>
          ...
          <PageSection id="bulk-import" className="py-8">
            <SectionContent size="lg">
              <div className="max-w-4xl mx-auto">
                <div className="bg-foreground/5 border border-foreground/10 rounded-2xl p-6 sm:p-8">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-lg bg-foreground/10 flex items-center justify-center flex-shrink-0">
                      <Upload className="w-5 h-5 text-foreground" />
                    </div>
                    <div className="space-y-3">
                      <h3 className="text-xl font-semibold text-foreground">Made for scale</h3>
                      ...
                      <Button
                        asChild
                        size="lg"
                        className="rounded-full px-6 py-5 text-base font-semibold bg-primary text-primary-foreground hover:bg-primary/90 cursor-pointer"
                      >
                        <a href="https://app.exit1.dev" target="_blank" rel="noopener noreferrer">
                          Open Bulk Import
            ...
            <SectionContent size="lg">
              <div className="max-w-4xl mx-auto space-y-10">
                <div className="space-y-3">
                  ...
                  <p className="text-lg text-foreground/60">Go to Checks &gt; Add Check and fill in:</p>
                </div>

                <div className="space-y-6 text-foreground/70">
                  <div className="space-y-2">
                    <div className="text-foreground font-semibold">URL / Host:Port</div>
                  ...
                  <div className="space-y-2">
                    <div className="text-foreground font-semibold">Display name</div>
                    <p>Friendly label for dashboards and alerts.</p>
                  </div>

                  <div className="space-y-2">
                    <div className="text-foreground font-semibold">Check type</div>
                    <ul className="space-y-2 list-disc pl-6">
                  ...
                  <div className="space-y-2">
                    <div className="text-foreground font-semibold">Check frequency</div>
                    <p>Choose how often we probe the target.</p>
                  </div>
                </div>

                <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-foreground mb-3">Recommended defaults</h3>
            ...
            <SectionContent size="lg">
              <div className="max-w-5xl mx-auto space-y-10">
                <div className="space-y-3">
                  ...
                  <p className="text-lg text-foreground/60">Use these settings to tune accuracy vs. noise.</p>
                </div>

                <div className="grid gap-6 md:grid-cols-2">
                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Check frequency</h3>
                    <p className="text-foreground/70">Pick from 1, 2, 5, 10, 15, 30, 60 minutes, or 24 hours.</p>
                    <ul className="space-y-2 text-foreground/70 list-disc pl-6">
                  ...
                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Immediate re-check (recommended)</h3>
                  ...
                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Down confirmation attempts</h3>
                    <p className="text-foreground/70">
                  ...
                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">HTTP method</h3>
                    <p className="text-foreground/70">For HTTP/HTTPS checks you can choose GET, POST, PUT, PATCH, DELETE, or HEAD.</p>
                    <p className="text-foreground/70">GET is recommended for uptime checks (some hosts block HEAD).</p>
                  </div>

                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Request headers</h3>
                    <p className="text-foreground/70">Add custom headers (one per line). Example:</p>
                    <pre className="text-xs sm:text-sm font-mono text-foreground/70 bg-background/40 border border-foreground/10 rounded-md p-3">
{`Authorization: Bearer YOUR_TOKEN
Accept: application/json`}
                    </pre>
                    <p className="text-foreground/70">Default User-Agent is Exit1-Website-Monitor/1.0.</p>
                  </div>

                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Request body</h3>
                    <p className="text-foreground/70">For POST/PUT/PATCH, provide a JSON body (or any plain text) that your endpoint expects.</p>
                  </div>

                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Response validation</h3>
                    <p className="text-foreground/70">Provide comma-separated keywords (for example: success,online,healthy).</p>
                    <p className="text-foreground/70">If none are found in the response body, the check is treated as failed.</p>
                  </div>

                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Force no-cache</h3>
                    <p className="text-foreground/70">Adds Cache-Control: no-cache to the request. Use this if your site is heavily cached.</p>
                  </div>

                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">Status handling</h3>
                    <p className="text-foreground/70">
                  ...
                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">TCP/UDP checks</h3>
                    <p className="text-foreground/70">
            ...
            <SectionContent size="lg">
              <div className="max-w-5xl mx-auto space-y-12">
                ...
                <div className="space-y-10">
                  <div className="bg-background/40 border border-foreground/10 rounded-lg p-6 space-y-6">
                    <div className="flex items-center gap-3">
                      <Mail className="w-5 h-5 text-foreground/60" />
                      <h3 className="text-2xl font-semibold">Email alerts</h3>
                    </div>
                    <div className="space-y-4">
                      <div className="text-foreground font-semibold">Setup</div>
                      <ol className="space-y-2 text-foreground/70 list-decimal pl-6">
                        <li>Go to Emails.</li>
                    ...
                    <div className="space-y-4">
                      <div className="text-foreground font-semibold">How email alerts behave</div>
                      <ul className="space-y-2 text-foreground/70 list-disc pl-6">
                  ...
                  <div className="bg-background/40 border border-foreground/10 rounded-lg p-6 space-y-6">
                    ...
                    <p className="text-foreground/70">Availability: SMS alerts are available on the Pro and Agency plans, or for administrators.</p>
                    <div className="space-y-4">
                      <div className="text-foreground font-semibold">Setup</div>
                      <ol className="space-y-2 text-foreground/70 list-decimal pl-6">
                        <li>Go to SMS.</li>
                    ...
                    <div className="space-y-4">
                      <div className="text-foreground font-semibold">How SMS alerts behave</div>
                      <ul className="space-y-2 text-foreground/70 list-disc pl-6">
                  ...
                  <div className="bg-background/40 border border-foreground/10 rounded-lg p-6 space-y-6">
                    <div className="flex items-center gap-3">
                      <Webhook className="w-5 h-5 text-foreground/60" />
                    ...
                    <div className="space-y-4">
                      <div className="text-foreground font-semibold">Notes</div>
                      <ul className="space-y-2 text-foreground/70 list-disc pl-6">
                        <li>Use a secret to help your receiver validate requests.</li>
                        <li>
                          Custom headers must be valid JSON (for example:{" "}
                          <span className="font-mono text-foreground/80">{`{\"Authorization\": \"Bearer TOKEN\"}`}</span>).
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <SectionContent size="lg">
              <div className="max-w-4xl mx-auto space-y-10">
                <div className="space-y-3 text-center">
                  ...
                  <p className="text-lg text-foreground/60">Logs help you understand why an alert fired.</p>
                </div>

                <div className="grid gap-6 md:grid-cols-2">
                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">How logs work</h3>
                    <ul className="space-y-2 text-foreground/70 list-disc pl-6">
                  ...
                  <div className="bg-foreground/5 border border-foreground/10 rounded-lg p-6 space-y-3">
                    <h3 className="text-xl font-semibold text-foreground">How to use logs</h3>
                    <ol className="space-y-2 text-foreground/70 list-decimal pl-6">
                      <li>Go to Logs.</li>
          ...
          <PageSection id="next" className="py-12">
            <SectionContent size="lg">
              <div className="max-w-4xl mx-auto space-y-6">
                ...
                <ul className="space-y-3 text-foreground/70 text-lg list-disc pl-6">
                  ...
                  <li>Read the <a href="https://docs.exit1.dev/getting-started" target="_blank" rel="noopener noreferrer" className="text-foreground underline underline-offset-4 hover:text-foreground/80 transition-colors">full documentation</a> for in-depth guides on every feature.</li>
                </ul>
              </div>
            </SectionContent>
          </PageSection>
