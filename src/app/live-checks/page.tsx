...
const LiveChecks = () => {
  ...
  const relatedFeatures = [
    ...
    },
    {
      ...
      description:
        "Stream from Frankfurt by default, or opt into the Boston region per check on Pro.",
