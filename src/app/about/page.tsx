            ...
            "@graph": [
              {
                ...
                "description": "Uptime monitoring with four plans — Free (10 monitors, 5-min checks), Nano ($9/mo, 50 monitors, 2-min checks), Pro ($24/mo, 500 monitors, 30-sec checks, SMS + API), and Agency ($49/mo, 1,000 monitors, 15-sec checks). SSL alerts and instant notifications included.",
                "publisher": { "@id": "#org" }
              },
              {
                "@type": "Person",
                ...
                <div className="prose prose-sm sm:prose lg:prose-lg max-w-none">
                  <div className="mb-12">
                    ...
                    <p className="text-base sm:text-lg text-foreground/70 mb-4">
                      Free, no-nonsense uptime monitoring. <strong>10 monitors. 5-minute checks. SSL monitoring. Instant alerts.</strong> The essentials — done right, and actually free. Paid plans start at $9/mo (Nano) for 50 monitors and 2-minute checks, up to 15-second checks on Agency.
                    </p>
                  </div>
                    ...
                    <div className="mb-8">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-base sm:text-lg text-foreground/70 font-medium">Founder & CTO</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mb-12">
                    ...
                    <ul className="space-y-3 text-base sm:text-lg text-foreground/70">
                      <li><strong>Real monitoring, not marketing.</strong> 10 free monitors with 5-min checks. Paid plans scale up to 1,000 monitors and 15-second checks.</li>
                  ...
                  <div className="mb-12">
                    ...
                    <ul className="space-y-2 text-base sm:text-lg text-foreground/70">
                      <li>Email: {email && (
                        <a
                          href={`mailto:${email}`}
                      ...
                      <li>LinkedIn: <a href="https://www.linkedin.com/in/mopradk/" target="_blank" rel="noopener noreferrer" className="text-foreground hover:underline cursor-pointer">Morten Pradsgaard</a></li>
                      <li>GitHub: <a href="https://github.com/Mopra" target="_blank" rel="noopener noreferrer" className="text-foreground hover:underline cursor-pointer">@Mopra</a></li>
                      <li>X (Twitter): <a href="https://x.com/m_prads" target="_blank" rel="noopener noreferrer" className="text-foreground hover:underline cursor-pointer">@m_prads</a></li>
                      <li>Discord: <a href="https://discord.gg/uZvWbpwJZS" target="_blank" rel="noopener noreferrer" className="text-foreground hover:underline cursor-pointer">Join the community and say hi</a></li>
                    </ul>
                  </div>
                </div>
              </SectionContent>
