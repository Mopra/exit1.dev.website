...
relatedFeatures={relatedFeatures}
        nanoUpgrade={{
          ...
          description: "Get texted when your site goes down — not hours later via email. Nano includes SMS alerts, team alerts (add others to SMS & email), and custom branding for just $3/month."
        }}
        video={{
          videoId: "lpGr0TkYXnA",
