...
const siteDescription = "The best free uptime and website monitoring stack with API observability and instant alerts. 50 monitors free with 5-minute checks and API access, or 1-minute checks from $4/mo. No credit card required.";
