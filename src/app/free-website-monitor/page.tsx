...
export const metadata: Metadata = {
  ...
  description:
    'exit1.dev delivers a free website monitor for ecommerce, landing pages, Jamstack, and marketing sites. 50 monitors with 5-minute checks free; paid plans scale to 1,000 monitors and 15-second intervals. SSL coverage, content validation, instant alerts.',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Monitor storefronts, landing pages, and static sites for free. 50 monitors, fast checks, content validation, SSL tracking, instant alerts. Paid plans scale to 1,000 monitors and 15-second intervals.',
    type: 'website',
...
const FreeWebsiteMonitorPage = () => {
  ...
  const faq = [
    ...
    },
    {
      ...
      answer:
        'Absolutely. We monitor Netlify, Vercel, GitHub Pages, Cloudflare Pages, or any CDN-backed site. No agents, no cron scripts, just HTTP checks from our European server.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'The free tier gives you 50 monitors. Indie ($4/mo) takes you to 100 at 1-minute checks, Nano ($9/mo) to 250 at 30 seconds, and Pro ($24/mo) to 1,000 monitors at 15 seconds across every microsite, promo page, and shop.',
    },
  ];
  ...
  const technicalDetails = {
    ...
    performance:
      '5-minute polling on free tier, down to 1-minute on Indie, 30-second on Nano, and 15-second on Pro. Multi-step verification before alerts fire. Response data stored for analytics and export.',
    api:
    ...
    <>
      <StructuredData
        ...
        data={{
          ...
          description:
            'Free website monitoring for ecommerce, landing pages, and Jamstack sites with 50 monitors, fast checks, SSL, and content validation. Paid plans scale up to 1,000 monitors with 15-second intervals.',
          url: 'https://exit1.dev/free-website-monitor',
          brand: {
            '@type': 'Brand',
            name: 'exit1.dev',
