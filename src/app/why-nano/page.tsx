  ...
  return (
    <PageShell>
      <PageContainer>
          ...
          <SectionContent size="md">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-xl border border-destructive/20 bg-destructive/5">
                <h3 className="font-semibold text-destructive mb-4">On Free</h3>
              ...
              <div className="p-6 rounded-xl border border-success/20 bg-success/5">
                <h3 className="font-semibold text-success mb-4">On Nano</h3>
                <ul className="space-y-3 text-foreground/70">
                  <li className="flex items-start gap-2">
        ...
        <PageSection className="py-16 border-t border-foreground/10">
          <SectionContent size="md">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-lg bg-foreground/10 flex items-center justify-center">
        ...
        <PageSection className="py-16 border-t border-foreground/10">
          <SectionContent size="md">
            ...
            <p className="text-lg text-foreground/70 mb-8">
              Nano is <strong className="text-foreground">$9/month</strong> billed monthly or <strong className="text-foreground">$84/year</strong> ($7/mo) billed annually.
            </p>

            <div className="p-6 rounded-xl border border-foreground/10 bg-foreground/5 mb-8">
              <h3 className="font-semibold mb-4">Need SMS, Slack, API access, or faster checks?</h3>
              <p className="text-foreground/70 mb-4">
                Those live on <strong className="text-foreground">Pro ($24/mo)</strong> — 500 monitors, 30-second checks, SMS alerts, Slack/Discord/Teams, API + MCP access, and a full year of history. Or go all-in with <strong className="text-foreground">Agency ($49/mo)</strong>: 1,000 monitors, 15-second checks, and 3 years of retention.
              </p>
              <Button
                asChild
                variant="outline"
            ...
            <div className="p-6 rounded-xl border border-success/30 bg-success/10">
              <p className="text-xl font-semibold text-center">
                Nano: <span className="text-success">$9/month</span>. 50 monitors, 2-minute checks, full status page builder.
              </p>
            </div>
          </SectionContent>
        </PageSection>
        ...
        {/* CTA */}
        <PageSection className="py-20 border-t border-foreground/10">
          <SectionContent size="sm" className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="rounded-full px-8 py-6 text-lg font-semibold border-foreground/20 hover:bg-foreground/5"
              >
                <Link href="/pricing">
                  Compare Plans
                </Link>
