          ...
          <PageSection className="pt-2 pb-8">
            <SectionContent size="lg">
              <div className="rounded-2xl border border-foreground/10 bg-foreground/[0.03] p-5 sm:p-6 text-sm text-foreground/70">
                ...
                free plan is free forever — 50 monitors, every protocol, SSL monitoring, API access, no credit card.
              </div>
            </SectionContent>
          </PageSection>
        )}
              ...
              <div className="flex flex-col sm:flex-row items-start gap-5">
                <div className="flex-1">
                  ...
                  <p className="text-foreground/70 text-sm sm:text-base">
                    50 monitors, every protocol, SSL monitoring, and instant alerts on the free plan.
