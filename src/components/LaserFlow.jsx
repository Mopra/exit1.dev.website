...
#define R_H 150.0
#define R_V 150.0
#define FLARE_HEIGHT 120.0
#define FLARE_AMOUNT 0.25
#define FLARE_EXP 1.0
#define TOP_FADE_START 0.6
#define TOP_FADE_EXP 0.6
#define FLOW_PERIOD 0.5
#define FLOW_SHARPNESS 1.5

#define W_BASE_X 0.4
#define W_LAYER_GAP 0.35
#define W_LANES 10
...
#define DITHER_STRENGTH 1.0
    ...
    float wR_V=R_V*uVLenFactor;
    float sPix=clamp(y/wR_V,0.0,1.0),bGain=pow(1.0-sPix,W_BOTTOM_EXP),sum=0.0;
    for(int s=0;s<2;++s){
    ...
    float span=smoothstep(-3.0,0.0,y)*(1.0-smoothstep(wR_V-6.0,wR_V,y));
